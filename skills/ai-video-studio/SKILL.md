...
description: "AI Video Studio — Generate + Edit + Export videos. Uses Seedance 2.0 for AI video generation, CapCut Mate for editing (timeline, captions, effects, BGM). Trigger: video, 视频, 剪辑, 生成视频, make video, edit video, 短视频, clip."
metadata:
  openclaw:
    emoji: "🎬"
    category: "creative"
    tags: ["video", "seedance", "capcut", "editing", "ai-generation", "短视频"]
    requires:
